...
/**
 * Main SDK response class with weather data.
...
public class WeatherResponse {
    ...
    public static class Temperature {
        ...
        /**
         * Converts feels-like temperature from Kelvin to Celsius
         */
        ...
        @Override
        public String toString() {
            return String.format("%.1fK (feels like %.1fK)", temp, feelsLike);
        }
    }
    ...
    /**
     * Nested class for system information (sunrise and sunset)
     */
